...
* **Street Address:**
    ...
    * **Allowed Characters:** Letters, numbers, spaces, dots, and hyphens.
* **Apartment:**
...
* **City:**
    ...
    * **Allowed Characters:** Letters, spaces, dots, and hyphens (no numbers).
* **State:**
    * **Optional:** Can be null/blank.
    * **Length:** Maximum 50 characters.
    * **Allowed Characters:** Letters, spaces, dots, and hyphens.
* **Postal Code:**
    * **Mandatory:** Cannot be blank.
    * **Length:** Between 3 and 10 characters.
    * **Allowed Characters:** Uppercase letters, numbers, spaces, and hyphens.
* **Country Code:**
    * **Mandatory:** Cannot be blank.
    * **Format:** Must be exactly 2 uppercase letters (ISO 3166-1 alpha-2).

### 5. Retrieval & Resource Handling (GET)
